...
syslink:
	...
	$(MAKE) -C $(SYSLINK_INSTALL_DIR) syslink_driver
	$(MAKE) -C $(SYSLINK_INSTALL_DIR) syslink_hlos

	$(MAKE) -C $(SYSLINK_INSTALL_DIR)/packages/ti/syslink/samples/hlos/common/usr/Linux/ ARCH=arm CROSS_COMPILE=../$($(combo_target)TOOLS_PREFIX) SYSLINK_PLATFORM=TI81XX ANDROID_ROOT=$(ANDROID_INSTALL_DIR) SYSLINK_ROOT=$(SYSLINK_INSTALL_DIR)/packages IPC_DIR=$(IPC_INSTALL_DIR)/packages  SYSLINK_VARIANT=$(SYSLINK_VARIANT_NAME) clean

	$(MAKE) -C $(SYSLINK_INSTALL_DIR)/packages/ti/syslink/samples/hlos/common/usr/Linux/ ARCH=arm CROSS_COMPILE=../$($(combo_target)TOOLS_PREFIX) SYSLINK_PLATFORM=TI81XX ANDROID_ROOT=$(ANDROID_INSTALL_DIR) SYSLINK_ROOT=$(SYSLINK_INSTALL_DIR)/packages IPC_DIR=$(IPC_INSTALL_DIR)/packages SYSLINK_VARIANT=$(SYSLINK_VARIANT_NAME)

	$(MAKE) -C $(SYSLINK_INSTALL_DIR)/packages/ti/syslink/samples/hlos/slaveLoader/usr/Linux ARCH=arm CROSS_COMPILE=../$($(combo_target)TOOLS_PREFIX) SYSLINK_PLATFORM=TI81XX ANDROID_ROOT=$(ANDROID_INSTALL_DIR) SYSLINK_ROOT=$(SYSLINK_INSTALL_DIR)/packages IPC_DIR=$(IPC_INSTALL_DIR)/packages SYSLINK_VARIANT=$(SYSLINK_VARIANT_NAME)  clean

	$(MAKE) -C $(SYSLINK_INSTALL_DIR)/packages/ti/syslink/samples/hlos/slaveLoader/usr/Linux ARCH=arm CROSS_COMPILE=../$($(combo_target)TOOLS_PREFIX) SYSLINK_PLATFORM=TI81XX ANDROID_ROOT=$(ANDROID_INSTALL_DIR) SYSLINK_ROOT=$(SYSLINK_INSTALL_DIR)/packages IPC_DIR=$(IPC_INSTALL_DIR)/packages SYSLINK_VARIANT=$(SYSLINK_VARIANT_NAME)
